 ...
 *
 * OUTPUT:
 *   ./recf-archive/         — all pages as .html files, assets downloaded
 *   ./recf-archive/INDEX.html — browse the full archive offline
 *   ./recf-archive/index.json — machine-readable page list
 */
...
const ZENDESK_API_BASE = "https://v5rc-kb.recf.org/api/v2/help_center/en-us";
// ─────────────────────────────────────────────────────────────────────────────
